 ...
 * Prompts users to sign up for updates.
 */
const NewsLetter = () => {
  return (
      ...
      <form className='bg-primary text-white px-4 rounded-xl md:rounded-[30px] flex flex-col justify-center items-center py-6 md:py-24'>
        ...
        <div className='flex-col justify-center w-full md:flex-row flex pt-12'>
          <input
            ...
            className='bg-[#026057] w-full h-11 md:h-16 mb-2 md:mb-0 rounded-xl pl-6 md:mr-5 md:w-[452px] text-white placeholder:text-white focus:outline-none'
          />
