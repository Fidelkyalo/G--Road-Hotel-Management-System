...
const hotelRoom = {
  ...
  fields: [
    ...
    defineField({
      name: 'coverImageSanity',
      title: 'Cover Image (Sanity Native)',
      type: 'image',
      options: {
        hotspot: true,
      },
      description: 'Upload the image here for better performance. This will override the URL field if present.',
    }),
    defineField({
      name: 'type',
      title: 'Room Type',
