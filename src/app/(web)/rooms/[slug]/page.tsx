 ...
 * Displays detailed information about a specific room and allows booking.
 * @param {Object} params - Route parameters containing the room slug.
 */
const RoomDetails = (props: { params: { slug: string } }) => {
  ...
  return (
    <div>
      <HotelPhotoGallery photos={room.images} slug={slug} />
